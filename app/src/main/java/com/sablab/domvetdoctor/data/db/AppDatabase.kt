package com.sablab.domvetdoctor.data.db

import android.content.Context
import androidx.room.Database
import androidx.room.Room
import androidx.room.RoomDatabase
import com.sablab.domvetdoctor.data.db.dao.*
import com.sablab.domvetdoctor.data.db.entries.*
...
abstract class AppDatabase : RoomDatabase() {
    ...
    companion object {
        ...
        fun instanse(context: Context? = null): AppDatabase {
