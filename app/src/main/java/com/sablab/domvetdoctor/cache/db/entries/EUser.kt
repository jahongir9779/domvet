...
class EUser(
    ...
    @ColumnInfo(name = COLUMN_USER_EDUCATION) var education: String? = "",
    ...
    companion object {
        ...
        const val COLUMN_USER_EDUCATION = "user_education"
        ...
        fun makeNUser(nUser: User): NUser {
            return NUser(
                phoneNumber = nUser.phoneNumber,
                regionId = nUser.regionId,
                status = nUser.status,
