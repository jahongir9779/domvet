...
import com.anymobile.domvet.ui.viewgroups.HistoryPostItem
import com.anymobile.domvet.ui.viewgroups.LoadingItemSmall
...
class HistoryCallsFragment @Inject constructor(private val viewModelFactory: ViewModelProvider.Factory) :
